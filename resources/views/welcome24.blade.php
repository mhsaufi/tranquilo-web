...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="myasset/css/fonticons.css">
        <link rel="stylesheet" href="myasset/fonts/stylesheet.css">
    ...
    <body data-spy="scroll" data-target="#navmenu">
                            ...
                            <nav class="navbar navbar-default" id="navmenu">
                                <div class="container-fluid">
                                    ...
                                    <div class="navbar-header">
                                        ...
                                        <a class="navbar-brand" href="{{ url('/') }}"><img src="{{ asset('/myasset/images/logo.png') }}" id="web_logo_ico"/></a>
                                    </div>
        ...
        <script src="myasset/js/jquery.easypiechart.min.js"></script>
