        ...
        <div class="row">
            <aside class="col-sm-4 col-sm-push-8">
                ...
                <div class="widget ads">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="background-color: blue;color:white;">
                            <h5>Latest Property</h5>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-6">
                            <a href="#"><img class="img-responsive img-rounded" src="myasset/images/ads/ad1.png" alt=""></a>
                        </div>

                        <div class="col-xs-6">
                            <a href="#"><img class="img-responsive img-rounded" src="myasset/images/ads/ad2.png" alt=""></a>
                        </div>
                    </div>
                    <p> </p>
                    <div class="row">
                        <div class="col-xs-6">
                            <a href="#"><img class="img-responsive img-rounded" src="myasset/images/ads/ad3.png" alt=""></a>
                        </div>

                        <div class="col-xs-6">
                            <a href="#"><img class="img-responsive img-rounded" src="myasset/images/ads/ad4.png" alt=""></a>
                        </div>
                    </div>
                </div><!--/.ads-->     
            ...
            <div class="col-sm-8 col-sm-pull-4">
                <div class="blog">
                    <div class="blog-item">
                        <img class="img-responsive img-blog" src="myasset/images/blog/blog1.jpg" width="100%" alt="" />
